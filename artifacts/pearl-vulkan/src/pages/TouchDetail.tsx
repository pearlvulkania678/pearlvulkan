...
export default function TouchDetail({ id }: { id: string }) {
  ...
  return (
    <PageShell>
      ...
      >
        ...
        <div>
          {item.subtitle && <p className="font-sans text-[10px] tracking-[0.3em] text-primary uppercase mb-3">{item.subtitle}</p>}
